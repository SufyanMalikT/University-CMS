...
class FeeVoucher(models.Model):
    ...
    student = models.ForeignKey(Student, related_name='fee_vouchers', on_delete=models.CASCADE)
    ...
    semester = models.ForeignKey(Semester, related_name='fee_vouchers', on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
class VoucherItem(models.Model):
    student = models.ForeignKey(Student, related_name='cart_items', on_delete=models.CASCADE)
    course_by_section = models.ForeignKey(CourseBySection ,related_name='voucher_items', on_delete=models.CASCADE)
