...
from .views import home_view, student_dashboard_view, student_add_courses_view, student_add_courses_page_view, \
                    ...
                    marks_details_page_view, download_transcript
...
urlpatterns = [
    ...
    path('dashboard/examinations/result/semester/<int:semester_id>',results_by_semester_page_view, name='semester_details'),
